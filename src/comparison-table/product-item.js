 ...
 * Block Registration
 */
registerBlockType('afpb/product-item', {
	title: __('Product Item', 'affiliaterg'),
	description: __(
		'Acts as Child block for Product Comparison Table',
		'affiliaterg'
	),
	icon: 'minus',
	...
	edit: ({ attributes, setAttributes, clientId }) => {
		...
		const blockProps = useBlockProps({
			className: `wp-block-afpb-product-item`,
		});
			...
			<Fragment>
				...
				>
					...
					<div className="product_photo">
						{url ? (
							<div className="display_tablecell">
								<img
									src={url}
									alt={alt}
