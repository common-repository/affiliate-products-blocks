...
export default function Edit({ attributes, setAttributes, clientId }) {
	...
	return (
		<Fragment>
			...
			<InspectorControls>
				<PanelBody
					title={__('Container Box', 'affiliaterg')}
					initialOpen={false}
				>
					<BorderControl
						colors={colors}
				...
				>
					...
					<ToggleControl
						label={__('Show Props', 'affiliaterg')}
						checked={showProps}
						onChange={() =>
							setAttributes({
								showProps: !showProps,
					...
					{showProps && (
						<Fragment>
							<TextControl
								label={__('Props Title', 'affiliaterg')}
								onChange={(value) =>
									setAttributes({ propsTitle: value })
								}
								value={propsTitle}
							/>
							<p className="afpb__label">
					...
					<ToggleControl
						label={__('Show Cons', 'affiliaterg')}
						checked={showCons}
						onChange={() =>
							setAttributes({
								showCons: !showCons,
					...
					{showCons && (
						<Fragment>
							<TextControl
								label={__('Cons Title', 'affiliaterg')}
								onChange={(value) =>
